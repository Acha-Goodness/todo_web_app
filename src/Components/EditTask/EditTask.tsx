...
const EditTask = ({closeEditTask} : ButtonProps) => {
  return (
    <div className='shadow-md p-5'>
        ...
        <div className='mt-3'>
            <textarea rows={3} placeholder='Create wireframe' className='w-[100%] p-1 bg-[#E6E8EB] rounded'/>
        ...
        <div className='mt-5'>
            ...
            <button className='rounded-md py-1 px-[15%] w-162.5px border border-[#3F5BF6] font-[600] text-[16px] bg-[#3F5BF6] text-white ml-4'>Add</button>
        </div>
    </div>
  )
}
